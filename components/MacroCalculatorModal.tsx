...
export const MacroCalculatorModal: React.FC<MacroCalculatorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      <div className="glass-panel max-w-2xl w-full p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl relative overflow-hidden max-h-[90vh] overflow-y-auto space-y-6">
        {/* Glow Accent */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3.5 py-2 text-xs text-slate-900 dark:text-white font-medium focus:outline-none focus:border-emerald-500"
            />
          </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold py-3 px-6 rounded-2xl shadow-lg shadow-emerald-500/20 transition-all hover:scale-[1.01] active:scale-[0.99]"
        >
          <Flame className="w-4 h-4" />
          <span>Calculate My Daily Macro Targets</span>
        </button>
          ...
          <div className="space-y-4 pt-2 border-t border-slate-200 dark:border-slate-800 animate-fadeIn">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 p-3 rounded-2xl text-center space-y-1">
                <div className="flex items-center justify-center gap-1 text-emerald-600 dark:text-emerald-400 text-xs font-semibold">
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">kcal / day</p>
              </div>

              {/* Protein */}
              <div className="bg-teal-500/10 border border-teal-500/20 p-3 rounded-2xl text-center space-y-1">
                <div className="flex items-center justify-center gap-1 text-teal-600 dark:text-teal-400 text-xs font-semibold">
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">daily goal</p>
              </div>

              {/* Fats */}
              <div className="bg-amber-500/10 border border-amber-500/20 p-3 rounded-2xl text-center space-y-1">
                <div className="flex items-center justify-center gap-1 text-amber-600 dark:text-amber-400 text-xs font-semibold">
              ...
              {/* Water */}
              <div className="bg-blue-500/10 border border-blue-500/20 p-3 rounded-2xl text-center space-y-1">
                <div className="flex items-center justify-center gap-1 text-blue-600 dark:text-blue-400 text-xs font-semibold">
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">hydration</p>
              </div>
            </div>

            {/* Health Guideline Limits */}
            <div className="bg-slate-100 dark:bg-slate-900 p-3 rounded-2xl border border-slate-200 dark:border-slate-800 text-xs flex flex-wrap items-center justify-between gap-2 text-slate-600 dark:text-slate-300">
              <div>
                <strong>Carbs Limit:</strong> {computedTargets.carbGrams}g / day
              </div>
              <div>
                <strong>Max Sodium:</strong> {computedTargets.sodiumMaxMg}mg / day
              </div>
              <div>
                <strong>Max Sugar:</strong> {computedTargets.sugarMaxGrams}g / day
              </div>
            </div>
          </div>
        )}
