...
* `category` (String, e.g., "Beverages", "Snacks", "Dairy", "Biscuits")
* `image_url` (String)
...
* **Product Card Grid (50+ seeded items):**
  * Product image, brand name, and product title.
...
* **"Why this affects you" section:** Highlight specific ingredients/nutrients that conflict with the user's selected conditions (e.g., *"Contains 24g added sugars — harmful for Diabetes"*).
* Quantity recommendation guidelines.

---

## 5. Seed Dataset Requirements (At least 50 Products)
Agent must create a seed script `seed_products.json` or SQL migration containing **at least 50 common real-world packaged items**, including:
...
2. **Database Migration & Seeding:**
   ...
   - Execute seed script with 50+ detailed commercial products.
